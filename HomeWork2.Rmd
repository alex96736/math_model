...
Наибольшая точночть у Байесовского классификатора, для него рассчитаем показатели TPR, SPC, PPV, NPV, FNR, FPR, FDR, MCC.

```{r}

TPR=tbl1[4]/(tbl1[4]+tbl1[2])
TPR
